// 供货商总控登录页（照抄 admin/pages/LoginPage.jsx）—— 复用后端 /auth/login type=agent。
// 本步接线需要真实 token 才能调 /issues，故先落一个最简登录。
...
export default function LoginPage() {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <div style={{ fontSize: 18, fontWeight: 600, color: COLORS.text }}>供货商总控登录</div>
          <div style={{ fontSize: 13, color: COLORS.textMuted, marginTop: 4 }}>boss.gamehub.dad · 请使用总控账号登录</div>
        </div>
