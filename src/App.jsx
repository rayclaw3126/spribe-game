...
export default function App() {
  ...
  // 其它游戏照旧免登录、本地模拟余额。
  const NEEDS_LOGIN = ['Aviator', 'Dice', 'Plinko', 'Mines', 'Limbo', 'HiLo', 'Keno', 'Goal', 'StreakRoll', 'MiniRoulette', 'SpeedGrid', 'NumberUp', 'HatTrick', 'GoldenBoot', 'HalfTime', 'WuXing', 'LineUp', 'DerbyDay']
