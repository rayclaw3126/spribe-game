...
export default function HatTrickRoad({ history = [], tab, onTab, isMobile = false, cols = 20, rows = 6, style }) {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          gridTemplateRows: `repeat(${rows}, 15px)`, gridTemplateColumns: `repeat(${cols}, 15px)`,
