...
export const GAME_REGISTRY = [
  { id: 'Aviator',      backendId: 'aviator',     name: 'Breakaway',  displayName: 'Breakaway',  venue: null,        desc: '抢在被扑倒前兑现！',     color: '#7C3AED', bg: 'linear-gradient(135deg, #EDE9FE, #DDD6FE)', cover: coverBreakaway,    cat: 'crash',  rooms: [] },
  ...
  { id: 'Limbo',        backendId: 'limbo',       name: 'Odds Climb', displayName: 'Odds Climb', venue: null,        desc: '设定目标赔率，开球攀升！', color: '#16C784', bg: INSTANT_BG,                                 cover: coverOddsClimb,    cat: 'crash',  rooms: [] },
  ...
  { id: 'Momentum',     backendId: 'momentum',    name: 'Momentum',   displayName: 'Momentum',   venue: null,        desc: '乘势而上，巅峰兑现！',   color: '#16C784', bg: INSTANT_BG,                                 cover: coverMomentum,     cat: 'crash',  rooms: [] },
